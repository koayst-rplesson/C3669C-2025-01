...
# It includes resources, tools, and prompts that clients can interact with.
...
auth = GitHubProvider(
   ...
   client_id = "Ov23li4sNgRJWBjZ5MWt" 

   # YOUR GITHUB_CLIENT_SECRET
   client_secret = "d158cc164ddf0ec953ba84333ebd5d930597b566"
   
   # MCP server base URL
   base_url = "https://hot-potato.fastmcp.app"
)
